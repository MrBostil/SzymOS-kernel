...
C_SRC = kernel/kernel.c kernel/terminal.c kernel/keyboard.c kernel/shell.c kernel/cpu.c kernel/memory.c kernel/filesystem.c kernel/ata.c kernel/disk_selector.c
